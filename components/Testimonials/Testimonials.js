          ...
          <div className="swiper-wrapper">
            {testimonials[locale].map((testimonial, index) => (
              <SwiperSlide
                ...
                className="flex-grow"
                style={{
                  height: slideHeight ? `${slideHeight - 10}px` : "auto",
                }}
              >
                <div className="group flex h-full flex-col justify-between rounded-xl border border-solid border-gray-300 bg-white p-6 transition-all duration-500 hover:border-amber-600 hover:shadow-sm">
                  <div className="flex flex-1 flex-col">
                    ...
                    <p className="flex-grow text-base leading-6 text-gray-600 transition-all duration-500 group-hover:text-gray-800">
                      {testimonial.message}
                    </p>
                  </div>
                  <div className="mt-6 flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
